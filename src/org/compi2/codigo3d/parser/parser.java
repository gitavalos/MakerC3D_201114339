...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Mar 17 21:05:55 CST 2017
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    ...
    "\000\040\002\ufff7\007\034\010\027\011\033\012\035\013" +
    "\031\015\ufff7\016\037\017\041\020\036\021\030\022\032" +
    "\023\042\024\ufff7\025\ufff7\001\002\000\040\002\uffe9\007" +
    "\uffe9\010\uffe9\011\uffe9\012\uffe9\013\uffe9\015\uffe9\016\uffe9" +
    "\017\uffe9\020\uffe9\021\uffe9\022\uffe9\023\uffe9\024\uffe9\025" +
    "\uffe9\001\002\000\010\002\uffff\024\021\025\022\001\002" +
    ...
    "\010\ufffe\014\ufffe\026\ufffe\001\002\000\016\004\015\005" +
    "\012\006\007\010\010\014\011\026\017\001\002\000\012" +
    "\002\ufffd\015\ufffd\024\021\025\ufffd\001\002\000\016\004" +
    ...
    "\ufff1\005\ufff1\006\ufff1\010\ufff1\014\ufff1\001\002\000\024" +
    "\002\ufff8\007\034\010\027\011\033\012\035\013\031\015" +
    ...
    "\000\040\002\uffef\007\uffef\010\uffef\011\033\012\035\013" +
    "\031\015\uffef\016\uffef\017\uffef\020\uffef\021\uffef\022\uffef" +
    "\023\uffef\024\uffef\025\uffef\001\002\000\010\015\052\024" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\010\003\013\004\012\005\050\001\001\000\002\001\001" +
    "\000\002\001\001\000\004\006\037\001\001\000\002\001" +
    "\001\000\002\001\001\000\010\003\013\004\012\005\017" +
    "\001\001\000\002\001\001\000\004\011\024\001\001\000" +
    "\004\010\022\001\001\000\010\003\013\004\012\005\023" +
      ...
      switch (CUP$parser$act_num)
		...
		String id = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new NodoC3D(id); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 23: // expresion ::= PAR_IZQ cond PAR_DER 
            {
              NodoC3D RESULT =null;
        ...
        RESULT = new NodoC3D(temp); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 16: // op_relacional ::= MENOR_IGUAL 
            {
              String RESULT =null;
		...
		TokenC3D cad = (TokenC3D)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = " <= "; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("op_relacional",4, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 15: // op_relacional ::= MAYOR_IGUAL 
            {
              String RESULT =null;
		int cadleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int cadright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		TokenC3D cad = (TokenC3D)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = " >= " ;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 14: // op_relacional ::= DIFERENTE 
            {
              String RESULT =null;
		int cadleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int cadright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		...
		NodoC3D exp = (NodoC3D)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // relacional ::= expresion op_relacional expresion 
            {
              NodoC3D RESULT =null;
		int izqleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int izqright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		...
		NodoC3D izq = (NodoC3D)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // cond ::= cond AND NT$2 cond 
            {
              NodoC3D RESULT =null;
